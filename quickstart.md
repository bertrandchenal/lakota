...
New timeseries:
	...
	bch@wsl:/tmp/data-dir$ lakota create temp_bxl "timestamp timestamp*" "value float"
...
First write:
	...
	bch@wsl:/tmp/data-dir$ cat input.csv | lakota write temp_bxl
	bch@wsl:/tmp/data-dir$ tree -h
	.
	├── [  96]  input-corrected.csv
	├── [  84]  input.csv
...
Second write:
	...
	bch@wsl:/tmp/data-dir$ cat input-corrected.csv | lakota write temp_bxl
	bch@wsl:/tmp/data-dir$ tree -h
	.
	├── [  96]  input-corrected.csv
	├── [  84]  input.csv
...
Read back the result:
	...
	bch@wsl:/tmp/data-dir$ lakota read temp_bxl
	timestamp              value
	-------------------  -------
...
Squash series:
	...
	bch@wsl:/tmp/data-dir$ lakota squash temp_bxl
	bch@wsl:/tmp/data-dir$ tree -h
	.
	├── [  96]  input-corrected.csv
	├── [  84]  input.csv
...
Garbage collection & squash registry series
	...
	bch@wsl:/tmp/data-dir$ lakota gc
	1 frames deleted
	bch@wsl:/tmp/data-dir$ tree -h
	.
	├── [  96]  input-corrected.csv
	...
	bch@wsl:/tmp/data-dir$ lakota squash
	bch@wsl:/tmp/data-dir$ lakota gc
	1 frames deleted
	bch@wsl:/tmp/data-dir$ tree -h
	.
